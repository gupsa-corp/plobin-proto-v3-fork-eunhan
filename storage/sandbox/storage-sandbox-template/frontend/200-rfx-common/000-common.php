...
$uploadPaths = [
    ...
    'rfx_root' => $rfxRoot,
    'uploads_dir' => $rfxRoot . '/uploads',
    'temp_dir' => $rfxRoot . '/temp',
    'downloads_dir' => $rfxRoot . '/014-downloads',
    'database_dir' => $rfxRoot . '/007-backend-database',
    'backend_php_dir' => $rfxRoot . '/005-backend-php'
];
...
function getRFXApiUrl($endpoint = '') {
    ...
    return $baseUrl . $sandboxBasePath . '/frontend/200-rfx-common/005-backend-php/' . ltrim($endpoint, '/');
}
...
function getRFXDownloadUrl($relativePath) {
    ...
    return $baseUrl . $sandboxBasePath . '/frontend/200-rfx-common/014-downloads/' . $relativePath;
}
