...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <?php include storage_path('sandbox/storage-sandbox-template/frontend/103-screen-table-view/100-header-stats.blade.php'); ?>

    <?php include storage_path('sandbox/storage-sandbox-template/frontend/103-screen-table-view/200-filter-bar.blade.php'); ?>

    <?php include storage_path('sandbox/storage-sandbox-template/frontend/103-screen-table-view/300-data-table.blade.php'); ?>
</div>
