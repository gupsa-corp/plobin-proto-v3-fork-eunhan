    ...
    <div class="min-h-screen" style="position: relative;">
        ...
        <div class="main-content" style="margin-left: 240px; min-height: 100vh;">
            <div class="p-6">
                ...
                {{-- 권한 로그 콘텐츠 --}}
                <div>
                    @include('900-page-platform-admin.905-permissions.904-tab-audit.100-header')
                    @include('900-page-platform-admin.905-permissions.904-tab-audit.200-content-main')
                </div>
            </div>
        </div>
    </div>
