...
return [
    ...
    '/organizations/{id}/settings/users' => ['view' => '800-page-organization-admin.809-page-settings-users.000-index', 'name' => 'organization.settings.users'],
    // 샌드박스 라우트들
    ...
    // 동적 샌드박스 템플릿 스크린 라우트 (모든 샌드박스 지원)
    '/sandbox/{sandbox}/{domain}/{screen}' => ['view' => '700-page-sandbox.706-page-custom-screens.100-template-screen-viewer', 'name' => 'sandbox.template-screen'],
